...
| :--- | :--- | :--- | :--- |
| `0x01` | Joystick 入力 (Steer/Accel/Brake/Buttons) | `custom_gamepad_report_t` | 2ms |
...
送信周期: 2ms (`Config::Time::HIDREPO_INTERVAL_MS`)
...
| `ffb_core0_update_shared(info)` | Core0 → 共有メモリへ書き込み |
| `ffb_core1_update_shared(input, effects)` | 共有メモリ → Core1 へ読み出し |
