...
| ピン番号 | 信号名 | 機能 | 備考 |
| :--- | :--- | :--- | :--- |
| 14 | S-Up Button | デジタル入力 (DI) | Active Low, 内部プルアップ |
| 15 | S-Down Button | デジタル入力 (DI) | Active Low, 内部プルアップ |
| ADC2 (28) | Brake | アナログ入力 (AI) | 面圧センサ入力 (Hi-R -> Lo-R) |
| ADC0 (26) | Accel | アナログ入力 (AI) | 電圧入力 (0.5V - 2.8V相当) |
...
### 4.1 通信・周期
*   **Sampling Interval:** 250us (ADC, DIの取得周期)
*   **Main Interval:** 1ms (ホストPCへのHIDレポート送信周期)
...
*   **入力電圧範囲:** 約0.5V ～ 2.8V
*   **ADC読取範囲:** 180 ～ 400 (10bit基準)

### 4.4 ブレーキ (Brake)
*   **構成:** プルアップ回路による分圧読み取り
*   **ADC読取範囲:** 100 ～ 750 (10bit基準)
