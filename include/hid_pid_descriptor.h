/**
 * @file hid_pid_descriptor.h
 * @brief USB HID PID (Physical Interface Device) レポートディスクリプタ定義
 *
 * @warning このファイルは hidwffb.cpp からのみインクルードすること。
 *          static
 * 配列として定義されているため、複数ファイルからインクルードすると
 *          多重定義エラーが発生する。
 *
 * @par 準拠仕様
 * - USB HID PID Specification v1.0
 *   https://www.usb.org/sites/default/files/pid1_01_0.pdf
 * - HID Usage Tables v1.3 (Usage Page 0x0F: Physical Interface Device)
 *   https://usb.org/sites/default/files/hut1_3_0.pdf
 * - USB HID Specification v1.11
 *   https://www.usb.org/sites/default/files/hid1_11.pdf
 *
 * @par ディスクリプタ構成
 * Application Collection: Joystick (Usage Page: Generic Desktop 0x01, Usage:
 * 0x04)
 *
 * [Input Reports]
 * - ID 0x01 : Joystick 入力 (Steer 16bit signed, Accel/Brake 16bit unsigned,
 * Buttons x16)
 * - ID 0x02 : PID State Report (エフェクト再生状態, アクチュエータ状態)
 *
 * [Output Reports] (Host -> Device / FFB命令)
 * - ID 0x01 : Set Effect Report       (エフェクト種別・パラメータ設定)
 * - ID 0x02 : Set Envelope Report     (エンベロープ設定)
 * - ID 0x03 : Set Condition Report    (Spring / Damper / Inertia / Friction)
 * - ID 0x04 : Set Periodic Report     (Sine / Square / Triangle / Sawtooth)
 * - ID 0x05 : Set Constant Force      (定常力エフェクト)
 * - ID 0x06 : Set Ramp Force          (ランプエフェクト)
 * - ID 0x0A : Effect Operation        (エフェクト Start / Stop)
 * - ID 0x0B : PID Block Free          (エフェクトスロット解放)
 * - ID 0x0C : PID Device Control      (Enable / Disable / Reset)
 * - ID 0x0D : Device Gain             (全体ゲイン設定)
 *
 * [Feature Reports] (DirectInput 初期化シーケンスで必須)
 * - ID 0x05 : Create New Effect       (エフェクト生成要求)
 * - ID 0x06 : PID Block Load          (スロット割当結果の応答)
 * - ID 0x07 : PID Pool Report         (デバイス容量情報)
 */
#ifndef HID_PID_DESCRIPTOR_H
#define HID_PID_DESCRIPTOR_H
#include <stdint.h>
// clang-format off
/**
 * @brief HIDレポートディスクリプタ本体
 *
 * @note hidwffb.cpp の static スコープでインクルードすること。
 *       外部リンケージを持たせる場合は方法Bへ移行すること。
 */
static uint8_t const desc_hid_report[] = {
    // -----------------------------------------------------------------------
    // Application Collection: Joystick
    // (USB HID Usage Tables: Generic Desktop Page 0x01, Usage 0x04)
    // -----------------------------------------------------------------------
    0x05, 0x01, // Usage Page (Generic Desktop)
    0x09, 0x04, // Usage (Joystick)
    0xA1, 0x01, // Collection (Application)
    // -----------------------------------------------------------------------
    // Input Report ID 0x01: Joystick 入力
    // -----------------------------------------------------------------------
    0x85, HID_ID_GAMEPAD_INPUT,   // Report ID (1)
    0x05, 0x01,       //   Usage Page (Generic Desktop)
    // X軸: ハンドル (符号付き 16bit, -32767..32767)
    0x09, 0x30,       //   Usage (X)
...
// =======================================================================
// FFB (PID) Reports from ArduinoJoystickWithFFBLibrary Reference
// =======================================================================
// PID State Report
  0x05, 0x0F,          // USAGE_PAGE (Physical Interface)
  0x09, 0x92,          // USAGE (PID State Report)
  0xA1, 0x02,          // COLLECTION (Logical)
	0x85, HID_ID_PID_STATE,         // REPORT_ID (02)
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_SET_ENVELOPE,        //Report ID 2
	0x09, 0x22,           //  Usage (Effect Block Index)
	0x15, 0x01,           //   Logical Minimum (1)
	0x25, 0x28,           //   Logical Maximum (40)
	0x35, 0x01,           //   Physical Minimum (1)
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_SET_CONDITION,       //Report ID 3
	0x09, 0x22,           //  Usage (Effect Block Index)
	0x15, 0x01,           //   Logical Minimum (1)
	0x25, 0x28,           //   Logical Maximum (40)
	0x35, 0x01,           //   Physical Minimum (1)
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_SET_PERIODIC,        //Report ID 4
	0x09, 0x22,           //  Usage (Effect Block Index)
	0x15, 0x01,           //   Logical Minimum (1)
	0x25, 0x28,           //   Logical Maximum (40)
	0x35, 0x01,           //   Physical Minimum (1)
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_SET_CONSTANT_FORCE,// Report ID 5
	0x09, 0x22,           //  Usage (Effect Block Index)
	0x15, 0x01,           //   Logical Minimum (1)
	0x25, 0x28,           //   Logical Maximum (40)
	0x35, 0x01,           //   Physical Minimum (1)
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_SET_RAMP_FORCE,    // Report ID 6
	0x09, 0x22,           //  Usage (Effect Block Index)
	0x15, 0x01,           //   Logical Minimum (1)
	0x25, 0x28,           //   Logical Maximum (40)
	0x35, 0x01,           //   Physical Minimum (1)
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_CUSTOM_FORCE_DATA, // Report ID 7
	0x09, 0x22,           //  Usage (Effect Block Index)
	0x15, 0x01,           //   Logical Minimum (1)
	0x25, 0x28,           //   Logical Maximum (40)
	0x35, 0x01,           //   Physical Minimum (1)
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_DOWNLOAD_FORCE_SAMPLE, // Report ID 8
	0x05, 0x01,           //  Usage Page (Generic Desktop)
	0x09, 0x30,           //    Usage (X)
	0x09, 0x31,           //    Usage (Y)
	0x15, 0x81,           //     Logical Minimum (-127)
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_EFFECT_OPERATION,  //Report ID 10
	0x09, 0x22,           //  Usage (Effect Block Index)
	0x15, 0x01,           //   Logical Minimum (1)
	0x25, 0x28,           //   Logical Maximum (40)
	0x35, 0x01,           //   Physical Minimum (1)
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_PID_BLOCK_FREE,    // Report ID 11
	0x09, 0x22,           //  Usage (Effect Block Index)
	0x15, 0x01,           //   Logical Minimum (1)
	0x25, 0x28,           //   Logical Maximum (40)
	0x35, 0x01,           //   Physical Minimum (1)
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_DEVICE_CONTROL,    // Report ID 12
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_DEVICE_GAIN,       //Report ID 13
  ...
  0xA1, 0x02,           //Collection Datalink (Logical)
	0x85, HID_ID_SET_CUSTOM_FORCE,  // Report ID 14
	0x09, 0x22,           //  Usage (Effect Block Index)
	0x15, 0x01,           //   Logical Minimum (1)
	0x25, 0x28,           //   Logical Maximum (40)
	0x35, 0x01,           //   Physical Minimum (1)
  ...
  0xA1, 0x02, // COLLECTION (Logical)
	0x85, HID_ID_CREATE_NEW_EFFECT, // REPORT_ID (05)
	0x09, 0x25, // USAGE (Effect Type)
	0xA1, 0x02, // COLLECTION (Logical)
	  0x09, 0x26, // USAGE (26)
	  0x09, 0x27, // USAGE (27)
  ...
  0xA1, 0x02, // COLLECTION (Logical)
	0x85, HID_ID_PID_BLOCK_LOAD,    // REPORT_ID (06)
	0x09, 0x22, // USAGE (Effect Block Index)
  ...
  0xA1, 0x02, // COLLECTION (Logical)
	0x85, HID_ID_PID_POOL,          // REPORT_ID (07)
